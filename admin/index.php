                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      ...
                      $rows=query("SELECT * FROM `user_info`");
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                      $rows=query("select * from `categories`");
                      $i=1;
                      while ($row=mysqli_fetch_array($rows)) {
                        $cat_id=$row['cat_id'];
                        $cat_title=$row['cat_title'];

                                  $rs=query("SELECT COUNT(*) AS count_items FROM products WHERE product_cat=$i");
                                  $i=1;
                  ...
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        ...
                        $rows=query("select * from email_info");
                        $i=1;
                        while ($row=mysqli_fetch_array($rows)) {
